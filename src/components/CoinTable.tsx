        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-white/20">
              ...
              <th className="px-4 py-3 text-right text-xs font-medium text-white/70 uppercase tracking-wider hidden sm:table-cell">
                Market Cap
              </th>
              <th className="px-4 py-3 text-right text-xs font-medium text-white/70 uppercase tracking-wider hidden lg:table-cell">
                Volume (24h)
              </th>
            </tr>
          </thead>
          <tbody className="divide-y divide-white/10">
            {coins.map((coin) => (
              <tr
                ...
                className="hover:bg-white/10 transition-all duration-150 cursor-pointer backdrop-blur-sm"
              >
              ...
              <td className="px-4 py-4 text-right text-white/80 hidden sm:table-cell">
                {formatLargeNumber(coin.market_cap, currency)}
              </td>
              <td className="px-4 py-4 text-right text-white/80 hidden lg:table-cell">
